...
package com.example.audebook.domain
...
import com.example.audebook.utils.copyToNewFile
import com.example.audebook.utils.extensions.copyToTempFile
import com.example.audebook.utils.extensions.moveTo
...
class PublicationRetriever(
    ...
    suspend fun retrieveFromStorage(
        ...
        Timber.d("FileTest "+ localResult.tempFile.absolutePath)
    ...
    private suspend fun moveToBookshelfDir(
        ...
        Timber.d("FileTest "+ tempFile.absolutePath)
