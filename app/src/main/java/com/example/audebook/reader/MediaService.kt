...
class MediaService : MediaSessionService() {
    ...
    inner class Binder : android.os.Binder() {
        ...
        private val app: com.example.audebook.Application
            get() = application as com.example.audebook.Application
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val readerRepository = (application as com.example.audebook.Application).readerRepository
...
//    }
    ...
    companion object {
        ...
        const val SERVICE_INTERFACE = "com.example.audebook.reader.MediaService"
